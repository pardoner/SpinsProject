...
function App() {
  ...
  return (
      <div className = "intro">
        ...
        <p>On the albums page, you'll be able to search through the Rolling Stone's Top 500 Albums selections. Press an album for more information. Log and organize a record collection virtually, or make a wishlist!</p>
        <p>Review and collect the albums you've been spinning!</p>
