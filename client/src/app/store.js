...
export const store = configureStore({
  ...
  reducer: { [spinsapi.reducerPath]: spinsapi.reducer // The key is the reducerPath we defined in our API service, and the value is the reducer
  ...
  middleware: (getDefaultMiddleware) =>
    getDefaultMiddleware().concat(spinsapi.middleware) // adding a custom middeware to existing middleware
});
